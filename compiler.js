...
function registerFunctions(lines) {
  const registry = {
    ...
    "load":     { arity: 1, validTypes: ["i32","i64","f32","f64"], output: "typed" },
    "load8_s":  { arity: 1, validTypes: ["i32","i64"],             output: "typed" },
    "load8_u":  { arity: 1, validTypes: ["i32","i64"],             output: "typed" },
    "load16_s": { arity: 1, validTypes: ["i32","i64"],             output: "typed" },
    "load16_u": { arity: 1, validTypes: ["i32","i64"],             output: "typed" },
    "load32_s": { arity: 1, validTypes: ["i64"],                   output: "typed" },
    "load32_u": { arity: 1, validTypes: ["i64"],                   output: "typed" },
